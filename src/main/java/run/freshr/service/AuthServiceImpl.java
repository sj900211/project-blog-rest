...
public class AuthServiceImpl implements AuthService {
  ...
  public ResponseEntity<?> getInfo() {
    ...
    return ok(ResponseData.builder().data(map(getSigned(), ManagerResponse.class)).build());
  }
  ...
  public ResponseEntity<?> updateInfo(SignUpdateRequest dto) {
    ...
    requireNonNull(getSigned()).updateEntity(decryptRsa(dto.getName(), encodePrivateKey));
  ...
  public ResponseEntity<?> removeInfo() {
    ...
    requireNonNull(getSigned()).removeEntity();
  ...
  public ResponseEntity<?> refreshAccessToken(RefreshTokenRequest dto) {
    ...
    Long id = access.getSignedId(); // 계정 일련 번호 조회
